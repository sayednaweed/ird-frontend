      ...
      <section>
        ...
        >
          {(data) => (
            <Card
              key={data.id}
              className="m-0 p-0 rounded-md shadow relative min-h-[310px] max-h-[310px] gap-y-3 hover:-translate-y-1 transition-transform min-w-[300px] md:w-[320px] duration-300 ease-out"
            >
