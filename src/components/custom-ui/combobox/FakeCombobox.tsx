...
export default function FakeCombobox(props: FakeComboboxProps) {
  ...
  return (
    <div className={cn("select-none cursor-not-allowed", className)}>
      <Label className="font-semibold rtl:text-lg-rtl ltr:text-lg-ltr">
        {title}
      </Label>
      <h1 className="px-4 mt-2 py-[10px] font-medium border rounded-md relative rtl:text-xl-rtl ltr:text-xl-ltr">
        {selected}
        {icon}
      </h1>
    </div>
